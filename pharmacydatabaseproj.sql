...
/****** Object:  Database [PharmacyDatabase]    Script Date: 10/10/2024 5:07:15 PM ******/
CREATE DATABASE [PharmacyDatabase]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PharmacyDatabase', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS02\MSSQL\DATA\PharmacyDatabase.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PharmacyDatabase_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS02\MSSQL\DATA\PharmacyDatabase_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [PharmacyDatabase] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [PharmacyDatabase] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [PharmacyDatabase] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [PharmacyDatabase] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [PharmacyDatabase] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [PharmacyDatabase] SET QUERY_STORE = ON
GO

ALTER DATABASE [PharmacyDatabase] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
